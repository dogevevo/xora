...
import Butom from "../components/Butom.jsx";
            ...
            <Element name='Pricing'>
                <div className='container'>
                    <div className='max-w pricing-head_before relative mx-auto border-l border-r border-s2  bg-s1/50 pb-40 pt-28 max-xl:max-w-4xl max-lg:border-none max-md:pb-32 max-md:pt-16'>
                        ...
                        <div className='relative z-4 mx-auto flex w-[375px] rounded-3xl border-[3px] border-s4/25 p-2 backdrop-blu[6px] max-md:w-[310px] '>
                        ...
                        <div className='pricing-bg'>
                            ...
                            <img src='/images/bg-outlines-fill.png' width={960} height={380} alt='outline' className='obsolute inset-0 opacity-5 mix-blend-soft-light ' />
                        </div>
                    </div>
                        ...
                        {plans.map((plan, index) => (
                            <div key={plan.id} className='pricing-plan_first pricing-plan_last pricing-plan_odd pricing-plan_even relative border-2  p-7 max-xl:min-w-80 max-lg:rounded-3xl xl:w-[calc(33.33%+2px)]'>
                                ...
                                <div className={clsx('relative flex flex-col items-center', index === 1 ? 'pt-24' : 'pt-12')}>
                                    <div className={clsx("small-2 rounded-20 relative z-2 max-auto mb-6 border-2 px-4 py-1.5 uppercase", index === 1 ? 'border-p3 text-p3 ' : 'border-p1 text-p1')}>
                                        {plan.title}
                                    </div>
                                ...
                                <ul className='mx-auto space-y-4 xl:px-7 '>
                                    {plan.features.map((feature) => (
                                        <li key={feature} className='relative flex items-center gap-5 '>
                                            <img src={"/images/check.png"} alt='check' className='size-10' />
                                            <p className='flex-1'>{feature}</p>
                                        </li>
                                    ))}
                                </ul>
                                <div className='mt-10 flex w-full justify-center'>
                                    <Butom icon={plan.icon}> Get Started </Butom>
                                </div>
